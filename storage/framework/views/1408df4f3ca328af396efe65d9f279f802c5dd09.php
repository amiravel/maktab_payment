...
<div>
    ...
    <div class="mb-4 px-4 md:p-0">
        ...
        <span wire:key="sorting-pill-<?php echo e($columnSelectName); ?>" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-indigo-100 text-indigo-800 capitalize dark:bg-indigo-200 dark:text-indigo-900">
            <?php echo e($column->getSortingPillTitle()); ?>: <?php echo e($column->getSortingPillDirection($component, $direction)); ?>


            <button wire:click="clearSort('<?php echo e($columnSelectName); ?>')" type="button" class="flex-shrink-0 mr-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center text-indigo-400 hover:bg-indigo-200 hover:text-indigo-500 focus:outline-none focus:bg-indigo-500 focus:text-white">
...
<div>
    ...
    <div class="mb-3">
        ...
        <span wire:key="sorting-pill-<?php echo e($columnSelectName); ?>" class="badge badge-pill badge-info d-inline-flex align-items-center">
            <?php echo e($column->getSortingPillTitle()); ?>: <?php echo e($column->getSortingPillDirection($component, $direction)); ?>
...
<div>
    ...
    <div class="mb-3">
        ...
        <span wire:key="sorting-pill-<?php echo e($columnSelectName); ?>" class="badge rounded-pill bg-info d-inline-flex align-items-center">
            <?php echo e($column->getSortingPillTitle()); ?>: <?php echo e($column->getSortingPillDirection($component, $direction)); ?>


            <a href="#" wire:click="clearSort('<?php echo e($columnSelectName); ?>')" class="text-white ms-2">
        ...
        <a href="#" wire:click.prevent="clearSorts" class="badge rounded-pill bg-light text-dark text-decoration-none">
            <?php echo app('translator')->get('Clear'); ?>
        </a>
    </div>
    <?php endif; ?>
</div>
<?php endif; ?><?php /**PATH /Users/ehsanmody/Code/Maktab/services/old/maktabpayment/resources/views/vendor/livewire-tables/components/tools/sorting-pills.blade.php ENDPATH**/ ?>