...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Refund')); ?> #<?php echo e($refund->id); ?>
            ...
            <a class="py-2 px-4 capitalize tracking-wide bg-blue-600 dark:bg-gray-800 text-white font-medium rounded hover:bg-blue-500 dark:hover:bg-gray-700 focus:outline-none focus:bg-blue-500 dark:focus:bg-gray-700"
               href="<?php echo e(route('refunds.index')); ?>"><?php echo e(__('Back')); ?></a>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <?php if(optional(optional($payment)->drive)->value == 'vandar'): ?>
            ...
            <div class="space-y-4">
                <?php if($payment): ?>
                    ...
                    <div class="flex w-full mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <?php if(is_string($mask_card_number)): ?>
                            <div class="px-4 py-2 -mx-3 w-full">
                                <div class="mx-3">
                                    <?php if(\Illuminate\Support\Str::is($mask_card_number, implode("-", str_split($refund->card_number, 4)))): ?>
                                        ...
                                        <li class="border-gray-400 flex flex-row w-full">
                                            <div
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div
                                                        class="text-gray-600 dark:text-gray-200 text-sm"><?php echo e(implode("-", str_split($refund->card_number, 4))); ?></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="border-gray-400 flex flex-row w-full">
                                            <div
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="text-gray-600 dark:text-gray-200 text-sm"
                                                         style="direction: ltr;"><?php echo e($mask_card_number); ?></div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="border-t border-gray-200">
                    <dl>
                        <?php $__currentLoopData = $refund->makeHidden(['id', 'uuid', 'seen', 'deleted_at'])->attributesToArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                        ...
                        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                            <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                                <h4 class="text-base leading-6 font-medium text-gray-900">
                                    <?php echo e(sprintf("Payment #%s", $payment->id)); ?>

                                </h4>

                                <a class="py-2 px-4 capitalize tracking-wide bg-blue-600 dark:bg-gray-800 text-white font-medium rounded hover:bg-blue-500 dark:hover:bg-gray-700 focus:outline-none focus:bg-blue-500 dark:focus:bg-gray-700"
                                   href="<?php echo e(route('payments.show', $payment)); ?>" target="_blank">
                                    <?php echo e(__('View')); ?> <?php echo e(__('Payment')); ?>

                                </a>
                            </div>
                            <div class="border-t border-gray-200">
                                <dl>
                                    <?php $__currentLoopData = $payment->makeHidden(['id', 'user_id', 'drive_id', 'information', 'callback', 'read', 'created_at', 'updated_at'])->attributesToArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div
                                            class="<?php if($refund->$key == $value): ?> bg-green-50 <?php elseif($loop->odd): ?> bg-gray-50 <?php else: ?> bg-white <?php endif; ?> px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            <dt class="text-sm font-medium text-gray-500">
                                                <?php echo e(__(\Illuminate\Support\Str::studly($key))); ?>
...
<?php endif; ?>
<?php /**PATH /Users/ehsanmody/Code/Maktab/services/old/maktabpayment/resources/views/refunds/show.blade.php ENDPATH**/ ?>