...
<?php if($theme === 'tailwind'): ?>
    <th scope="col" <?php echo e($attributes->merge($customAttributes)
            ->class(['px-6 py-3 text-right text-xs font-medium whitespace-nowrap text-gray-500 uppercase tracking-wider dark:bg-gray-800 dark:text-gray-400' => $customAttributes['default'] ?? true])
...
<?php endif; ?>
<?php /**PATH /Users/ehsanmody/Code/Maktab/services/old/maktabpayment/resources/views/vendor/livewire-tables/components/table/th.blade.php ENDPATH**/ ?>