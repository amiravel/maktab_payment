<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('cycles.index') }}" :active="request()->routeIs('cycles.index')">
                {{ __('Cycles') }}
            </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{ route('refunds.index') }}" :active="request()->routeIs('refunds.index')">
                {{ __('Refunds') }}
            </x-jet-responsive-nav-link>
        </div>
